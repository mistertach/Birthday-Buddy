...
import { signInWithGoogle, signInWithApple } from '@/lib/actions';
    ...
    return (
        <div className="flex flex-col gap-3">
            <form action={signInWithGoogle}>
                <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-[#dadce0] rounded-lg text-[#3c4043] text-sm font-semibold shadow-sm hover:bg-gray-50 hover:shadow-md transition-all duration-150"
                >
                    <GoogleIcon />
            ...
            <form action={signInWithApple}>
                <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-black border border-black rounded-lg text-white text-sm font-semibold shadow-sm hover:bg-zinc-800 transition-all duration-150"
                >
                    <AppleIcon />
                    Continue with Apple
                </button>
